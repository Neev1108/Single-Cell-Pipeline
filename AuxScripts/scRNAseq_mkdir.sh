...
mkdir 01-CellRanger/CellRanger_Output
...
mkdir Preprocessing_Scripts/02-Scanpy/Images
mkdir Preprocessing_Scripts/02-Scanpy/VV_logs
mkdir Preprocessing_Scripts/03-ScoreCT/Marker_genes
mkdir Preprocessing_Scripts/03-ScoreCT/Annotation_Exports
mkdir Preprocessing_Scripts/03-ScoreCT/tSNE_UMAP
